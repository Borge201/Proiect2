...
; 0000 006A PORTA.4=0;  //pin 21 4A
; 0000 006B PORTA.5=0;  //pin 22 4F
	CBI  0x2,5
; 0000 006C PORTA.6=1;  //pin 23 4G
	SBI  0x2,6
; 0000 006D }
...
; 0000 012D   if(consZi==0)
	TST  R9
	BRNE _0x167
; 0000 012E   {if(contorHr<24)
	LDI  R30,LOW(24)
	CP   R5,R30
	BRSH _0x168
; 0000 012F      { for(i=0;i<contorHr+1;i++)
	LDI  R16,LOW(0)
_0x16A:
	MOV  R30,R5
	LDI  R31,0
	...
	CPC  R27,R31
	BRGE _0x16B
; 0000 0130       {   SUMA=SUMA+arrayOre[i];
	MOV  R30,R16
	RCALL SUBOPT_0x1
	ADD  R17,R30
; 0000 0131       // ne va arata consumul pana la ora curenta de la pornire
; 0000 0132       }
	SUBI R16,-1
	RJMP _0x16A
_0x16B:
; 0000 0133       val_afisor=SUMA;
	RJMP _0x186
; 0000 0134       }
; 0000 0135    else
_0x168:
; 0000 0136    { for(i=0;i<contorHr;i++)
	LDI  R16,LOW(0)
_0x16E:
	CP   R16,R5
	BRSH _0x16F
; 0000 0137       {   SUMA=SUMA+arrayOre[i];
	MOV  R30,R16
	RCALL SUBOPT_0x1
	ADD  R17,R30
; 0000 0138       // ne va arata consumul pana la ora curenta de la pornire in caz ca consZi e 0
; 0000 0139       }
	SUBI R16,-1
	RJMP _0x16E
_0x16F:
; 0000 013A       val_afisor=SUMA;
_0x186:
	MOV  R8,R17
; 0000 013B    }
; 0000 013C   }
; 0000 013D   else{
	RJMP _0x170
_0x167:
; 0000 013E   val_afisor=consZi;
	MOV  R8,R9
; 0000 013F   }
_0x170:
; 0000 0140 
; 0000 0141   //sfarsitul buton apasat
; 0000 0142  }
; 0000 0143    else
	RJMP _0x171
_0x166:
; 0000 0144   {val_afisor=totalConsum;
	MOV  R8,R10
; 0000 0145         }
_0x171:
; 0000 0146    return val_afisor;
	MOV  R30,R8
	LD   R16,Y+
	LD   R17,Y+
	RET
...
_main:
; .FSTART _main
; 0000 014D // Declare your local variables here
; 0000 014E  //DSP ar trebui sa trimita ceva de genul 00100 pentru un puls simplu
; 0000 014F // Crystal Oscillator division factor: 1
; 0000 0150 #pragma optsize-
; 0000 0151 CLKPR=(1<<CLKPCE);
	LDI  R30,LOW(128)
	STS  97,R30
; 0000 0152 CLKPR=(0<<CLKPCE) | (0<<CLKPS3) | (0<<CLKPS2) | (0<<CLKPS1) | (0<<CLKPS0);
	LDI  R30,LOW(0)
	STS  97,R30
; 0000 0153 #ifdef _OPTIMIZE_SIZE_
; 0000 0154 #pragma optsize+
; 0000 0155 #endif
; 0000 0156 
; 0000 0157 // Input/Output Ports initialization
; 0000 0158 // Port A initialization
; 0000 0159 // Function: Bit7=Out Bit6=Out Bit5=Out Bit4=Out Bit3=Out Bit2=Out Bit1=Out Bit0=Out
; 0000 015A DDRA=(1<<DDA7) | (1<<DDA6) | (1<<DDA5) | (1<<DDA4) | (1<<DDA3) | (1<<DDA2) | (1<<DDA1) | (1<<DDA0);
	LDI  R30,LOW(255)
	OUT  0x1,R30
; 0000 015B // State: Bit7=1 Bit6=1 Bit5=1 Bit4=1 Bit3=1 Bit2=1 Bit1=1 Bit0=1
; 0000 015C PORTA=(1<<PORTA7) | (1<<PORTA6) | (1<<PORTA5) | (1<<PORTA4) | (1<<PORTA3) | (1<<PORTA2) | (1<<PORTA1) | (1<<PORTA0);
	OUT  0x2,R30
; 0000 015D 
; 0000 015E // Port B initialization
; 0000 015F // Function: Bit7=In Bit6=In Bit5=In Bit4=Out Bit3=Out Bit2=Out Bit1=Out Bit0=Out
; 0000 0160 DDRB=(0<<DDB7) | (0<<DDB6) | (0<<DDB5) | (1<<DDB4) | (1<<DDB3) | (1<<DDB2) | (1<<DDB1) | (1<<DDB0);
	LDI  R30,LOW(31)
	OUT  0x4,R30
; 0000 0161 // State: Bit7=T Bit6=T Bit5=T Bit4=1 Bit3=1 Bit2=1 Bit1=1 Bit0=1
; 0000 0162 PORTB=(0<<PORTB7) | (0<<PORTB6) | (0<<PORTB5) | (1<<PORTB4) | (1<<PORTB3) | (1<<PORTB2) | (1<<PORTB1) | (1<<PORTB0);
	OUT  0x5,R30
; 0000 0163 
; 0000 0164 // Port C initialization
; 0000 0165 // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=In Bit2=In Bit1=In Bit0=In
; 0000 0166 DDRC=(0<<DDC7) | (0<<DDC6) | (0<<DDC5) | (0<<DDC4) | (0<<DDC3) | (0<<DDC2) | (0<<DDC1) | (0<<DDC0);
	LDI  R30,LOW(0)
	OUT  0x7,R30
; 0000 0167 // State: Bit7=P Bit6=P Bit5=P Bit4=P Bit3=P Bit2=P Bit1=P Bit0=P
; 0000 0168 PORTC=(1<<PORTC7) | (1<<PORTC6) | (1<<PORTC5) | (1<<PORTC4) | (1<<PORTC3) | (1<<PORTC2) | (1<<PORTC1) | (1<<PORTC0);
	LDI  R30,LOW(255)
	OUT  0x8,R30
; 0000 0169 
; 0000 016A // Port D initialization
; 0000 016B // Function: Bit7=Out Bit6=In Bit5=In Bit4=Out Bit3=Out Bit2=Out Bit1=In Bit0=In
; 0000 016C DDRD=(1<<DDD7) | (1<<DDD6) | (0<<DDD5) | (1<<DDD4) | (1<<DDD3) | (1<<DDD2) | (0<<DDD1) | (0<<DDD0);
	LDI  R30,LOW(220)
	OUT  0xA,R30
; 0000 016D // State: Bit7=1 Bit6=0 Bit5=T Bit4=0 Bit3=0 Bit2=0 Bit1=T Bit0=T
; 0000 016E PORTD=(1<<PORTD7) | (1<<PORTD6) | (0<<PORTD5) | (1<<PORTD4) | (1<<PORTD3) | (1<<PORTD2) | (0<<PORTD1) | (0<<PORTD0);
	OUT  0xB,R30
; 0000 016F 
; 0000 0170 // Timer/Counter 0 initialization
; 0000 0171 // Clock source: System Clock
; 0000 0172 // Clock value: 19.531 kHz
; 0000 0173 // Mode: Normal top=0xFF
; 0000 0174 // OC0A output: Disconnected
; 0000 0175 // OC0B output: Disconnected
; 0000 0176 // Timer Period: 10.035 ms
; 0000 0177 TCCR0A=(0<<COM0A1) | (0<<COM0A0) | (0<<COM0B1) | (0<<COM0B0) | (0<<WGM01) | (0<<WGM00);
	LDI  R30,LOW(0)
	OUT  0x24,R30
; 0000 0178 TCCR0B=(0<<WGM02) | (1<<CS02) | (0<<CS01) | (1<<CS00);
	LDI  R30,LOW(5)
	OUT  0x25,R30
; 0000 0179 TCNT0=0x3C;
	LDI  R30,LOW(60)
	OUT  0x26,R30
; 0000 017A OCR0A=0x00;
	LDI  R30,LOW(0)
	OUT  0x27,R30
; 0000 017B OCR0B=0x00;
	OUT  0x28,R30
; 0000 017C 
...
; 0000 0189 TCCR1A=(0<<COM1A1) | (0<<COM1A0) | (0<<COM1B1) | (0<<COM1B0) | (0<<WGM11) | (0<<WGM10);
	STS  128,R30
; 0000 018A TCCR1B=(0<<ICNC1) | (0<<ICES1) | (0<<WGM13) | (0<<WGM12) | (0<<CS12) | (0<<CS11) | (0<<CS10);
	STS  129,R30
...
; 0000 0196 // Clock value: Timer2 Stopped
; 0000 0197 // Mode: Normal top=0xFF
; 0000 0198 // OC2A output: Disconnected
; 0000 0199 // OC2B output: Disconnected
; 0000 019A ASSR=(0<<EXCLK) | (0<<AS2);
	STS  182,R30
; 0000 019B TCCR2A=(0<<COM2A1) | (0<<COM2A0) | (0<<COM2B1) | (0<<COM2B0) | (0<<WGM21) | (0<<WGM20);
	STS  176,R30
; 0000 019C TCCR2B=(0<<WGM22) | (0<<CS22) | (0<<CS21) | (0<<CS20);
	STS  177,R30
; 0000 019D TCNT2=0x00;
	STS  178,R30
; 0000 019E OCR2A=0x00;
	STS  179,R30
; 0000 019F OCR2B=0x00;
	STS  180,R30
; 0000 01A0 
; 0000 01A1 // Timer/Counter 0 Interrupt(s) initialization
; 0000 01A2 TIMSK0=(0<<OCIE0B) | (0<<OCIE0A) | (1<<TOIE0);
	LDI  R30,LOW(1)
	STS  110,R30
; 0000 01A3 
; 0000 01A4 // Timer/Counter 1 Interrupt(s) initialization
; 0000 01A5 TIMSK1=(0<<ICIE1) | (0<<OCIE1B) | (0<<OCIE1A) | (0<<TOIE1);
	LDI  R30,LOW(0)
	STS  111,R30
; 0000 01A6 
; 0000 01A7 // Timer/Counter 2 Interrupt(s) initialization
; 0000 01A8 TIMSK2=(0<<OCIE2B) | (0<<OCIE2A) | (0<<TOIE2);
	STS  112,R30
; 0000 01A9 
; 0000 01AA // External Interrupt(s) initialization
; 0000 01AB // INT0: Off
; 0000 01AC // INT1: Off
; 0000 01AD // INT2: Off
; 0000 01AE // Interrupt on any change on pins PCINT0-7: Off
; 0000 01AF // Interrupt on any change on pins PCINT8-15: Off
; 0000 01B0 // Interrupt on any change on pins PCINT16-23: Off
; 0000 01B1 // Interrupt on any change on pins PCINT24-31: Off
; 0000 01B2 EICRA=(0<<ISC21) | (0<<ISC20) | (0<<ISC11) | (0<<ISC10) | (0<<ISC01) | (0<<ISC00);
	STS  105,R30
; 0000 01B3 EIMSK=(0<<INT2) | (0<<INT1) | (0<<INT0);
	OUT  0x1D,R30
; 0000 01B4 PCICR=(0<<PCIE3) | (0<<PCIE2) | (0<<PCIE1) | (0<<PCIE0);
	STS  104,R30
; 0000 01B5 
; 0000 01B6 // USART0 initialization
; 0000 01B7 // USART0 disabled
; 0000 01B8 UCSR0B=(0<<RXCIE0) | (0<<TXCIE0) | (0<<UDRIE0) | (0<<RXEN0) | (0<<TXEN0) | (0<<UCSZ02) | (0<<RXB80) | (0<<TXB80);
	STS  193,R30
; 0000 01B9 
...
; 0000 01C4 ACSR=(1<<ACD) | (0<<ACBG) | (0<<ACO) | (0<<ACI) | (0<<ACIE) | (0<<ACIC) | (0<<ACIS1) | (0<<ACIS0);
	LDI  R30,LOW(128)
	OUT  0x30,R30
; 0000 01C5 ADCSRB=(0<<ACME);
	LDI  R30,LOW(0)
	STS  123,R30
; 0000 01C6 // Digital input buffer on AIN0: On
; 0000 01C7 // Digital input buffer on AIN1: On
; 0000 01C8 DIDR1=(0<<AIN0D) | (0<<AIN1D);
	STS  127,R30
; 0000 01C9 
; 0000 01CA // ADC initialization
; 0000 01CB // ADC disabled
; 0000 01CC ADCSRA=(0<<ADEN) | (0<<ADSC) | (0<<ADATE) | (0<<ADIF) | (0<<ADIE) | (0<<ADPS2) | (0<<ADPS1) | (0<<ADPS0);
	STS  122,R30
; 0000 01CD 
; 0000 01CE // SPI initialization
; 0000 01CF // SPI disabled
; 0000 01D0 SPCR=(0<<SPIE) | (0<<SPE) | (0<<DORD) | (0<<MSTR) | (0<<CPOL) | (0<<CPHA) | (0<<SPR1) | (0<<SPR0);
	OUT  0x2C,R30
; 0000 01D1 
...
; 0000 01D4 TWCR=(0<<TWEA) | (0<<TWSTA) | (0<<TWSTO) | (0<<TWEN) | (0<<TWIE);
	STS  188,R30
; 0000 01D5 
; 0000 01D6 // Globally enable interrupts
; 0000 01D7 #asm("sei")
	SEI
; 0000 01D8 
; 0000 01D9 while (1)
...
; 0000 01DA       {  PIND.6=0;
	CBI  0x9,6
; 0000 01DB       LED_Stare_Curent();
	RCALL _LED_Stare_Curent
; 0000 01DC 
; 0000 01DD       if(PINC.0==1 )
	SBIS 0x6,0
	RJMP _0x177
; 0000 01DE       {
; 0000 01DF         cont_pulse=0;
	CLR  R7
; 0000 01E0         while(PINC.0!=0)
_0x178:
	SBIS 0x6,0
	RJMP _0x17A
; 0000 01E1           {
; 0000 01E2           if(PINC.1==1)
	SBIC 0x6,1
; 0000 01E3             {
; 0000 01E4             cont_pulse=cont_pulse+1;
	INC  R7
; 0000 01E5             }
; 0000 01E6 
; 0000 01E7           }
...
_0x17A:
; 0000 01E8       }
; 0000 01E9       totalConsum=totalConsum+cont_pulse;
_0x177:
	ADD  R10,R7
; 0000 01EA       arrayOre[contorHr]= arrayOre[contorHr]+cont_pulse ;
	MOV  R26,R5
	LDI  R27,0
...
; 0000 01EB       cont_pulse=0;
	CLR  R7
; 0000 01EC       Afisor_2Cifre(ValAfisorButon());
